...
export default function AdminFormItems() {
  ...
  const visible = useMemo(() => items.filter((item) => item.form_type === catalog).sort((a, b) => a.sort_order - b.sort_order), [items, catalog])
