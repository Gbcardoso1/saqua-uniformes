        ...
        <Tabs defaultValue="uniformes" className="w-full">
          <TabsList className="grid w-full grid-cols-5 h-auto">
            <TabsTrigger value="uniformes" className="flex flex-col gap-1 py-3">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-RpnmRr4QdkkBv3JN1aw797sUzwAh48.png" alt="" className="h-6 w-6 object-contain" />
            ...
            <TabsTrigger value="kits" className="flex flex-col gap-1 py-3">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-2FDaJwdo2SJeN84EKdH0IWSuQ6MxtR.png" alt="" className="h-7 w-7 object-contain" />
