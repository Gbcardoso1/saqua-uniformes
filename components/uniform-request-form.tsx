        ...
        <Tabs defaultValue="uniformes" className="w-full">
          <TabsList className="grid w-full grid-cols-5 h-auto">
            <TabsTrigger value="uniformes" className="flex flex-col gap-1 py-3">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-Y60tOE8ma2KrHLjCaIpLpEyBKtnszi.png" alt="" className="h-8 w-10 object-contain" />
            ...
            <TabsTrigger value="kits" className="flex flex-col gap-1 py-3">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-lj1CI99BZx7Ot109BqqLBoXKeCL4uL.png" alt="" className="h-8 w-10 object-contain" />
