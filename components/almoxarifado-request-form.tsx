...
const stationeryCategories = {
  ...
  "Cadernos, Agendas e Blocos": [
    "AGENDA CRECHE (KIT ESCOLAR 2025 )",
    "AGENDA ESCOLAR [ EJA 2024 ]",
    "CADERNO 10 MATERIAS EJA (KIT ESCOLAR).",
  ...
  "Papel Cartão e Couché": [
    ...
    "PAPEL COUCHE - ROSA CLARO - 10 FLS",
  ],
  "Papel Celofane": [
...
const kitchenItemsList = [
  ...
  "BACIA BOWL INOX C/ TAMPA - 18 CM UND.",
